            ...
            <div class="ats-pagination tablenav" style="justify-self: left"  dir="ltr">
                <div class="tablenav-pages">
                    ...
                    <span class="displaying-num"><?php
                        ...
                        printf(esc_html__('%s items', 'ats-moknah'), esc_html(number_format_i18n($total_rows))); ?></span>
                    <span class="pagination-links">
                        ...
                        <span class="paging-input"><?php
                            ...
                            printf(esc_html__('%1$s of %2$s', 'ats-moknah'), esc_html($current), esc_html($total_pages)); ?></span>
